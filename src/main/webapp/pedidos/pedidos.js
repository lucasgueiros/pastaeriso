...
function salvarNovo() {
  var pedido = {
    ...
    "contato_preferencial" : {
      ...
      "contatosForma" : $("#contatosForma").val(),
    },
    "enderecoEntrega" : {
      "rua" : $("#rua").val(),
      "numero" : $("#numero").val(),
      "bairro" : $("#bairro").val(),
      "enderecoComentarios" : $("#enderecoComentarios").val(),
  ...
  $("#pedidoItensBody").children('tr').each(function(i){
    ...
    if(localStorage.getItem("clienteId") !== ) {
      ...
      pedido.contato_preferencial = null;
      if(localStorage.getItem("enderecoEntrega") !== ) {
        pedido.enderecoEntrega = localStorage.getItem("enderecoEntrega");
      }
    }
  });
